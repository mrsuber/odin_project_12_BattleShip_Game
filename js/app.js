// document.addEventListener('DOMContentLoader', firstFunction)
  ...
  const infoDisplay = document.querySelector("#into")
  const userSquares=[]
...
//draw the computer ships and random location
...
function checkForWins(){
  ...
  if(cpuDestroyerCount===2){
    infoDisplay.innerHTML = "Your  destroyer sunk"
    cpuDestroyerCount=10
  }
  if(cpuSubmarineCount===3){
    infoDisplay.innerHTML = "Your submarine sunk"
    cpuSubmarineCount=10
  }
  if(cpuCruiserCount===3){
    infoDisplay.innerHTML = "Your  cruiser sunk"
    cpuCruiserCount=10
  }

  if(cpuBattleshipCount===4){
    infoDisplay.innerHTML = "Your battleship sunk"
    cpuBattleshipCount=10
  }
  if(cpuCarrierCount===5){
    infoDisplay.innerHTML = "Your carrier sunk"
    cpuCarrierCount=10
  }
